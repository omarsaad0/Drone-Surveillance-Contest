...
def main(_argv):
    ...
    while True:
        ...
        # draw bbox on screen
            ...
            #cv2.line(frame, (0, int(3*height/6-height/5)), (width, int(3*height/6-height/5)), (0, 255, 0), thickness=2)

        #cv2.line(frame, (0, height-250), (width, height-250), (0, 255, 0),thickness=2)
       ...
       # cv2.putText(frame, "Current Vehicle Count: " + str(current_count), (0, 80), 0, 1, (0, 0, 255), 2)
            ...
            cv2.putText(frame, "Omar Saad " , (int((width/2)-100), 100), 0, 2, (255, 0, 0), 2)
